...
import { OneCXBookmarkListComponent } from './chat-panel.component'
...
bootstrapRemoteComponent(OneCXBookmarkListComponent, 'ocx-chat-panel-component', environment.production, [
